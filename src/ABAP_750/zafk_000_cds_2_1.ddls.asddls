@AbapCatalog.sqlViewName: 'ZAFK_CDS_2_1'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED
@EndUserText.label: 'cds 2.ödev_1'
define view zafk_000_cds_2_1
  as select from    vbrp
    inner join      vbrk on vbrp.vbeln = vbrk.vbeln
    inner join      mara on mara.matnr = vbrp.matnr
    left outer join vbak on vbak.vbeln = vbrp.vbeln
                         ...
                         and makt.spras = $session.system_language
{
  ...
  key vbrp.posnr,
      ...
      length( mara.matnr )                                    as matnr_lentgh,
      case vbrk.fkart
